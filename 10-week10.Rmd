...
* `Hmisc`, preferably version 0.5-2: for more under-the-hood spatial data management
...
Let's go ahead and look at ourdata.
...
```{r 10-rad-plot-zero, warnings=FALSE, message=FALSE, cache=TRUE, tidy=TRUE}
