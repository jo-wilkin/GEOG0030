...
**This part of the practical is in progress and will be released ASAP (i.e. late Wednesday 27th). Please make sure to read through the Q-GIS practical prior to completing this one.**
...
<!-- 1. Click on **Aggregate Points** within the **Summarise Data** option after clicking on the **Perform Analysis** button when hovering over the `March_theft_2020` point dataset. -->
...
<!-- 3. And run - note this processing for the borough level will take around 5 minutes to process. -->
...
<!-- *Note, if your processing did not work, you can find two pre-processed Ward and Borough shapefiles with population and crime count here.* -->

<!-- Let's add our Crime Rate statistic: -->
...
<!-- This is all possible using the field calculator in AGOL, but will require some thinking about the right expression. -->
