...
1. Understnading different geometric operations and spatial queries and their respective applications.
...
You will need to also download the Train and Tube Stations data from TfL from their **Open Data** portal [here](https://tfl.gov.uk/info-for/open-data-users/our-open-data?intcmp=3671). 

You'll find the data under **General -> Station locations**. 

We need to download the **KML** file. Move your download to your `raw` data folder and create a new `transport` folder to contain it.
...
### Practical 6 - Part One: Geometric Operations & Spatial Queries In Action {-}
