...
<center>**We are interested in the Mid-2011 Persons.**</center>
...
```{r echo=FALSE, out.width = "5500pt", fig.align='center', cache=TRUE}
...
**Now, the join that you have created between your ward and population datasets in only held in Q-GIS's memory.** 
    * **If you were to close the program now, you would lose this join and have to repeat it the next time you opened Q-GIS.** 
    * **To prevent this from happening, we need to export our dataset to a new shapefile - and then re-add this to the map.**
...
**Next Steps: Joining our 2015 and 2019 data**

You now need to **repeat this whole process** for your 2015 and 2019 datasets. Remember, you need to:

* Load the Ward dataset as a Vector Layer

* Load the Population dataset as a Delimited Text File Layer (remember the settings!)
